...
pacf(detrend_model$residuals, main = "PACF of Residuals of detrending model", lag.max = 200, xlabs = "Lags")
```
...
According to the nature of CPI, $CPI(t) = \frac{\sum_{i \in \mathcal{P}} P_{i,t} Q_i}{\sum_{i \in \mathcal{P}} P_{i,0} Q_i}$, where $\mathcal{P}$ is the set of all goods and services, $P_{i,t}$ is the price of good or service $i$ at time $t$, and $Q_i$ is the quantity of good or service $i$ at the base period. 
